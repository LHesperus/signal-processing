...
a_t=1;
Ysigma_dp=sigma_dp(s,a_t,fs,fc,2)     
Ysigma_ap=sigma_ap(s,a_t,fs,fc,2)     
Ymu_f_42=mu_f_42(s,fs,Rs,2)           
Ymu_a_42=mu_a_42(s,2)                                  %not use func in book
Ysigma_a=sigma_a(s,0.2,2)                              %there threshold I take 0.2 by test 
Ysigma_af=sigma_af(s,a_t,fs,Rs,2)     
Ysigma_aa=sigma_aa(s,2)               
Ygamma_max=MaxSpectralDensity(s,2)    
